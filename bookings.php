          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item active">
                ...
                <button style="padding:4px; background-color:#ffffff; border-color:black;"><a href="index.php">Log Out</a></button>
              </ul>
            </div>
          </nav>
        </div>
        ...
        <tbody>
          ...
          <?php if (count($documents) > 0): ?>
            <?php foreach ($documents as $document): ?>
                <tr>
                    <td><?= htmlspecialchars($document->_id) ?></td>
                    <td><?= htmlspecialchars($document->name) ?></td>
                    <td><?= htmlspecialchars($document->email) ?></td>
                    <td><?= htmlspecialchars($document->phone) ?></td>
                    <td><?= htmlspecialchars($document->id_card) ?></td>
                    <td><?= htmlspecialchars($document->gender) ?></td>
                    <td>
                        <a href="update.php?id=<?= $document->_id ?>">Update</a> |
